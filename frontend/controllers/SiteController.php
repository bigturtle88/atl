...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if ($searchForm->load(Yii::$app->request->post()) && $searchForm->validate()) {
          ...
          $price = (new TypeCost())->priceList($searchForm);
    ...
    /**
    * Print cost city list
    *
    * @param int $id
    * @return array
    */
    public function actionCostCityList($id = null)
    {
        if($id!=null){

          $typeCost =  (new TypeCost())->costCityList($id);
          echo  $typeCost;
         }
         return null;
